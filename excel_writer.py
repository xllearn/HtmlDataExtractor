...
EVIDENCE_COLUMNS = ["source_id", "info_id", "row_index", "field", "value", "evidence", "confidence", "source", "rule_name"]
CONFLICT_COLUMNS = ["source_id", "info_id", "row_index", "field", "rule_value", "llm_value", "final_value", "reason"]
...
def write_excel(
    ...
    conflict_evidence: Iterable[Dict[str, Any]] | None = None,
) -> str:
    ...
    conflict_sheet = ensure_sheet(workbook, CONFLICT_SHEET)
